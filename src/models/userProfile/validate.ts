 ...
 */
function validateExperience(exp: Experience): ValidationResult {
 ...
 */
function validateProject(proj: Project): ValidationResult {
  const errors: ValidationError[] = [];
 ...
 */
export function validate(profile: UserProfile): ValidationResult {
  const errors: ValidationError[] = [];
